...
# Description: alter perentage fields to begin with pct_ in aarp_demographics tables (pct, pm, ph)..
...
#go to aarp_demographics tables (county, blockgroup, state, zipcode) in gdb
datasetList = arcpy.ListTables("*")  #only tables that have _aarp_demographics at the end
